...
/*
 * 创建多线程程序的第二种方法：实现Runnable接口
 * java.lang.Runnable接口：Runnable 接口应该由那些打算通过某一线程执行其实例的类来实现，类必须定义一个称为 run 的无参数方法
 *
 * java.lang.Thread类的构造方法：
 *      public Thread(Runnable target) 分配新的 Thread 对象
 *      public Thread(ThreadGroup group, Runnable target) 分配新的 Thread 对象
 *
 * 实现步骤：
