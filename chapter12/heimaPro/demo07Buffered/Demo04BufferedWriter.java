 ...
 *      int sz：指定缓冲区的大小，不写是默认大小
 *
 * 特有的成员方法：
 * public void newLine() throws IOException 写入一个行分隔符，会根据不同的操作系统，获取不同的行分隔符
 * 换行：换行符号
 *      windows：\r\n
 *      linux：/n
 *      mac：/r
...
public class Demo04BufferedWriter {
    public static void main(String[] args) throws IOException {
        //1、创建字符缓冲输出流对象，构造方法中传递字符输出流
        BufferedWriter bw = new BufferedWriter(new FileWriter("F:\\Java\\Project\\Study\\src\\chapter12\\heimaPro\\demo07Buffered\\test.txt"));
        //2、调用字符缓冲输出流的方法write，把数据写入到内存缓冲区中
        for (int i = 0; i < 3; i++) {
            bw.write("你好" + i);
//            bw.write("\r\n");
