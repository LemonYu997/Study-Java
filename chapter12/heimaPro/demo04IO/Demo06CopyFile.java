...
/*
 * 明确：
 *      数据源：F:\Java\Project\Study\src\chapter12\heimaPro\demo04IO\test.jpg
 *      数据的目的地：F:\Java\Project\Study\src\chapter12\heimaPro\demo03Filter\test.jpg
 * 文件复制的步骤：
...
//        }
        ...
        //5、释放资源(先关闭写的，后关闭读的，如果写完了，肯定读取完毕)
        fos.close();
        fis.close();
